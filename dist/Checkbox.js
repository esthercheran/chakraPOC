...
var require_emotion_element_b63ca7c6_cjs_dev = __commonJS({
  "node_modules/@emotion/react/dist/emotion-element-b63ca7c6.cjs.dev.js"(exports) {
    ...
    var EmotionCacheContext = /* @__PURE__ */ React17.createContext(typeof HTMLElement !== "undefined" ? /* @__PURE__ */ createCache__default["default"]({
      key: "css"
    }) : null);
    if (true) {
    ...
    var ThemeProvider2 = function ThemeProvider3(props) {
      var theme3 = React17.useContext(ThemeContext2);
    ...
    function withTheme(Component) {
      ...
      var render = function render2(props, ref) {
        var theme3 = React17.useContext(ThemeContext2);
        return /* @__PURE__ */ React17.createElement(Component, _extends({
          theme: theme3,
          ref
        }, props));
      };
    ...
    var Emotion = /* @__PURE__ */ exports.withEmotionCache(function(props, cache, ref) {
      ...
      var serialized = serialize.serializeStyles(registeredStyles, void 0, React17.useContext(ThemeContext2));
...
var Toast = (props) => {
  ...
  return /* @__PURE__ */ import_react40.default.createElement(Alert, {
    addRole: false,
    status,
    variant,
    ...
    textAlign: "start",
    width: "auto"
  }, /* @__PURE__ */ import_react40.default.createElement(AlertIcon, null, icon), /* @__PURE__ */ import_react40.default.createElement(chakra.div, {
    flex: "1",
    maxWidth: "100%"
  }, title && /* @__PURE__ */ import_react40.default.createElement(AlertTitle, {
    id: ids == null ? void 0 : ids.title
  }, title), description && /* @__PURE__ */ import_react40.default.createElement(AlertDescription, {
    id: ids == null ? void 0 : ids.description,
    display: "block"
  }, description)), isClosable && /* @__PURE__ */ import_react40.default.createElement(CloseButton, {
    size: "sm",
    onClick: onClose,
    position: "absolute",
    insetEnd: 1,
...
function createRenderToast(options = {}) {
  ...
  const renderToast = (props) => {
    ...
    return /* @__PURE__ */ import_react40.default.createElement(ToastComponent2, {
      ...props,
      ...options
    });
  };
...
var ToastComponent = (0, import_react42.memo)((props) => {
  const {
    id,
    message,
    onCloseComplete,
  ...
  const [delay, setDelay] = (0, import_react42.useState)(duration);
  ...
  const containerStyles = (0, import_react42.useMemo)(() => ({
    pointerEvents: "auto",
    maxWidth: 560,
    minWidth: 300,
    margin: toastSpacing,
  ...
  const toastStyle = (0, import_react42.useMemo)(() => getToastStyle(position2), [position2]);
  return /* @__PURE__ */ import_react40.default.createElement(motion2.li, {
    layout: true,
    ...
    style: toastStyle
  }, /* @__PURE__ */ import_react40.default.createElement(chakra.div, {
    role: "status",
    "aria-atomic": "true",
...
var ToastProvider = (props) => {
  const state2 = (0, import_react43.useSyncExternalStore)(toastStore.subscribe, toastStore.getState, toastStore.getState);
  const {
    children,
    motionVariants,
  ...
  const toastList = stateKeys.map((position2) => {
    ...
    }, /* @__PURE__ */ import_react40.default.createElement(AnimatePresence2, {
      initial: false
    }, toasts.map((toast) => /* @__PURE__ */ import_react40.default.createElement(Component, {
      key: toast.id,
      motionVariants,
      ...toast
    }))));
  });
  return /* @__PURE__ */ import_react40.default.createElement(import_react40.default.Fragment, null, children, /* @__PURE__ */ import_react40.default.createElement(Portal, {
    ...portalProps
  }, toastList));
};
...
var ChakraProvider = (props) => {
  ...
  const _children = /* @__PURE__ */ import_react44.default.createElement(EnvironmentProvider, {
    environment
  }, children);
  return /* @__PURE__ */ import_react44.default.createElement(ThemeProvider, {
    theme: theme3,
    cssVarsRoot
  }, /* @__PURE__ */ import_react44.default.createElement(ColorModeProvider, {
    colorModeManager,
    options: theme3.config
  }, resetCSS ? /* @__PURE__ */ import_react44.default.createElement(CSSReset, null) : /* @__PURE__ */ import_react44.default.createElement(CSSPolyfill, null), /* @__PURE__ */ import_react44.default.createElement(GlobalStyle, null), portalZIndex ? /* @__PURE__ */ import_react44.default.createElement(PortalManager, {
    zIndex: portalZIndex
  }, _children) : _children));
};
...
function ChakraProvider2({
  ...
  return /* @__PURE__ */ import_react45.default.createElement(ChakraProvider, {
    theme: theme22,
    ...restProps
  }, children, /* @__PURE__ */ import_react45.default.createElement(ToastProvider, {
    ...toastOptions
  }));
}
