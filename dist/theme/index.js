...
var colors2 = {
  dark: {
    "btn-primary-default-background-color": "#0ea5e9",
    ...
    "semantic-color-actions-cta-default-border-color": "#0ea5e9",
    "semantic-color-actions-cta-default-text-color": "#ffffff",
    "semantic-color-actions-cta-default-background-color": "#0ea5e9",
    ...
    "semantic-color-actions-cta-focus-border-color": "#0ea5e9",
    "semantic-color-actions-cta-focus-text-color": "#ffffff",
    "semantic-color-actions-cta-focus-background-color": "#0ea5e9",
    ...
    "semantic-color-inputs-selected-default-border-color": "#0ea5e9",
    "semantic-color-inputs-selected-default-text-color": "#0ea5e9",
    "semantic-color-inputs-selected-default-icon-color": "#0ea5e9",
  ...
  light: {
    ...
    "color-neutrals-white": "#ffffff",
    "color-neutrals-transparent": "hsla(255,0%,100%,0.01)",
    "checkbox-unselected-default-border-color": "#0ea5e9",
    ...
    "checkbox-selected-default-border-color": "#0ea5e9",
    "checkbox-selected-default-background-color": "#0ea5e9",
    ...
    "radio-unselected-default-border-color": "#0ea5e9",
    ...
    "radio-selected-default-border-color": "#0ea5e9",
    ...
    "switch-selected-default-border-color": "#0ea5e9",
    ...
    "avatar-background-color": "#0ea5e9",
    "tag-default-background-color": "#9ca3af",
    "tag-default-text-color": "#ffffff",
    "tag-default-icon-color": "#ffffff",
    "heading-text-color": "#374151",
    "icon-icon-color": "#0ea5e9",
    "icon-button-primary-default-border-color": "#e0f2fe",
    "icon-button-primary-default-background-color": "#0ea5e9",
    "icon-button-primary-default-icon-color": "#ffffff",
    ...
    "icon-button-primary-hover-border-color": "#e0f2fe",
    "icon-button-primary-hover-background-color": "#38bdf8",
    "icon-button-primary-hover-icon-color": "#ffffff",
    "icon-button-primary-hover-ghost-background-color": "#38bdf8",
    "icon-button-primary-hover-ghost-icon-color": "#ffffff",
    "icon-button-primary-active-border-color": "#e0f2fe",
    "icon-button-primary-active-background-color": "#0284c7",
    "icon-button-primary-active-icon-color": "#ffffff",
    "icon-button-primary-active-ghost-background-color": "#0284c7",
    "icon-button-primary-active-ghost-icocn-color": "#ffffff",
    "icon-button-secondary-default-border-color": "#4b5563",
    "icon-button-secondary-default-background": "hsla(255,0%,100%,0.01)",
    "icon-button-secondary-default-icon-color": "#4b5563",
    "icon-button-secondary-hover-border-color": "#d1d5db",
    "icon-button-secondary-hover-background-color": "#d1d5db",
    "icon-button-secondary-hover-icon-color": "#4b5563",
    "icon-button-secondary-active-border-color": "#6b7280",
    "icon-button-secondary-active-background-color": "#6b7280",
    "icon-button-secondary-active-icon-color": "#ffffff",
    "icon-button-negative-default-background-color": "hsla(255,0%,100%,0.01)",
    "icon-button-negative-default-border-color": "#f87171",
    "icon-button-negative-default-icon-color": "#f87171",
    "icon-button-negative-hover-border-color": "#fca5a5",
    "icon-button-negative-hover-background-color": "#fca5a5",
    "icon-button-negative-hover-icon-color": "#ffffff",
    "icon-button-negative-active-border-color": "#ef4444",
    "icon-button-negative-active-background-color": "#ef4444",
    "icon-button-negative-active-icon-color": "#ffffff",
    "icon-button-disabled-border-color": "#6b7280",
    "icon-button-disabled-background-color": "#d1d5db",
    "icon-button-disabled-icon-color": "#6b7280",
    "icon-button-disabled-ghost-background-color": "hsla(255,0%,100%,0.01)",
    "icon-button-disabled-ghost-icon-color": "#6b7280",
    ...
    "tab-selected-soft-background-color": "#0ea5e9",
...
var fonts = {
  dark: {
    ...
    "semantic-font-family-actions": "IBM Plex Sans",
    "semantic-font-family-inputs": "IBM Plex Sans",
    "semantic-font-family-font-family-inputs": "IBM Plex Sans",
    "semantic-font-family-font-family-actions": "IBM Plex Sans",
    "semantic-font-family-font-family-typography-serif": "IBM Plex Serif",
    "semantic-font-family-font-family-typography-sans-serif": "IBM Plex Sans",
    "semantic-font-family-font-family-typography-mono": "IBM Plex Mono",
    "semantic-font-family-font-family-feedback": "IBM Plex Sans",
    "semantic-font-family-font-family-status": "IBM Plex Sans",
    "semantic-font-family-font-family-navigation": "IBM Plex Sans",
    "semantic-font-family-typography-serif": "IBM Plex Serif",
    "semantic-font-family-typography-sans-serif": "IBM Plex Sans",
    "semantic-font-family-typography-mono": "IBM Plex Mono",
    "semantic-font-family-status": "IBM Plex Sans",
    "semantic-font-family-navigation": "IBM Plex Sans",
  ...
  light: {
    ...
    "avatar-font-family": "IBM Plex Sans",
    "tag-font-family": "IBM Plex Sans",
    "heading-font-family": "IBM Plex Sans",
    "tab-font-family": "IBM Plex Sans",
    "text-font-family": "IBM Plex Sans",
    "tooltip-font-family": "IBM Plex Sans"
  }
};
var fontWeights = {
  dark: {
