...
var colors2 = {
  dark: {
    ...
    "semantic-color-navigation-background-color": "#0ea5e9",
    "semantic-color-navigation-border-color": "#0284c7",
    "semantic-color-navigation-font-color": "#ffffff",
    "semantic-color-navigation-icon-color": "#ffffff",
    ...
    "avatar-background-color": "#0284c7"
  },
  light: {
    "btn-primary-default-background-color": "#0ea5e9",
    "btn-primary-default-text-color": "#ffffff",
    ...
    "avatar-badge-border-color": "#ffffff",
    "avatar-background-color": "#0284c7"
  }
};
var radii2 = {
