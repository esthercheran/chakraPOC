...
var Tag = forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ import_react29.default.createElement(TagStylesProvider, {
    value: styles2
  }, /* @__PURE__ */ import_react29.default.createElement(chakra.span, {
    ref,
    ...ownProps,
...
var TagLabel = forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ import_react29.default.createElement(chakra.span, {
    ref,
    noOfLines: 1,
    ...props,
    __css: styles2.label
...
var TagLeftIcon = forwardRef((props, ref) => /* @__PURE__ */ import_react29.default.createElement(Icon, {
  ref,
  verticalAlign: "top",
  marginEnd: "0.5rem",
  ...props
...
var TagRightIcon = forwardRef((props, ref) => /* @__PURE__ */ import_react29.default.createElement(Icon, {
  ref,
  verticalAlign: "top",
  marginStart: "0.5rem",
  ...props
...
var TagCloseIcon = (props) => /* @__PURE__ */ import_react29.default.createElement(Icon, {
...
var TagCloseButton = (props) => {
  ...
  return /* @__PURE__ */ import_react29.default.createElement(chakra.button, {
    "aria-label": "close",
    ...rest,
    type: "button",
    disabled: isDisabled,
    __css: btnStyles
  }, children || /* @__PURE__ */ import_react29.default.createElement(TagCloseIcon, null));
};
...
var Toast = (props) => {
  ...
  return /* @__PURE__ */ import_react31.default.createElement(Alert, {
    addRole: false,
    status,
    variant,
    ...
    textAlign: "start",
    width: "auto"
  }, /* @__PURE__ */ import_react31.default.createElement(AlertIcon, null, icon), /* @__PURE__ */ import_react31.default.createElement(chakra.div, {
    flex: "1",
    maxWidth: "100%"
  }, title && /* @__PURE__ */ import_react31.default.createElement(AlertTitle, {
    id: ids == null ? void 0 : ids.title
  }, title), description && /* @__PURE__ */ import_react31.default.createElement(AlertDescription, {
    id: ids == null ? void 0 : ids.description,
    display: "block"
  }, description)), isClosable && /* @__PURE__ */ import_react31.default.createElement(CloseButton, {
    size: "sm",
    onClick: onClose,
    position: "absolute",
    insetEnd: 1,
...
function createRenderToast(options = {}) {
  ...
  const renderToast = (props) => {
    ...
    return /* @__PURE__ */ import_react31.default.createElement(ToastComponent2, {
      ...props,
      ...options
    });
  };
...
var ToastComponent = (0, import_react33.memo)((props) => {
  ...
  return /* @__PURE__ */ import_react31.default.createElement(motion.li, {
    layout: true,
    ...
    style: toastStyle
  }, /* @__PURE__ */ import_react31.default.createElement(chakra.div, {
    role: "status",
    "aria-atomic": "true",
...
var ToastProvider = (props) => {
  const state2 = (0, import_react34.useSyncExternalStore)(toastStore.subscribe, toastStore.getState, toastStore.getState);
  const {
    children,
    motionVariants,
  ...
  const toastList = stateKeys.map((position2) => {
    ...
    }, /* @__PURE__ */ import_react31.default.createElement(AnimatePresence, {
      initial: false
    }, toasts.map((toast) => /* @__PURE__ */ import_react31.default.createElement(Component, {
      key: toast.id,
      motionVariants,
      ...toast
    }))));
  });
  return /* @__PURE__ */ import_react31.default.createElement(import_react31.default.Fragment, null, children, /* @__PURE__ */ import_react31.default.createElement(Portal, {
    ...portalProps
  }, toastList));
};
...
var ChakraProvider = (props) => {
  ...
  const _children = /* @__PURE__ */ import_react35.default.createElement(EnvironmentProvider, {
    environment
  }, children);
  return /* @__PURE__ */ import_react35.default.createElement(ThemeProvider, {
    theme: theme3,
    cssVarsRoot
  }, /* @__PURE__ */ import_react35.default.createElement(ColorModeProvider, {
    colorModeManager,
    options: theme3.config
  }, resetCSS ? /* @__PURE__ */ import_react35.default.createElement(CSSReset, null) : /* @__PURE__ */ import_react35.default.createElement(CSSPolyfill, null), /* @__PURE__ */ import_react35.default.createElement(GlobalStyle, null), portalZIndex ? /* @__PURE__ */ import_react35.default.createElement(PortalManager, {
    zIndex: portalZIndex
  }, _children) : _children));
};
...
function ChakraProvider2({
  ...
  return /* @__PURE__ */ import_react36.default.createElement(ChakraProvider, {
    theme: theme22,
    ...restProps
  }, children, /* @__PURE__ */ import_react36.default.createElement(ToastProvider, {
    ...toastOptions
  }));
}
...
function TagChakra(props) {
  return /* @__PURE__ */ React14.createElement(ChakraProvider2, {
    resetCSS: true,
    theme: theme2
  }, /* @__PURE__ */ React14.createElement(Tag, __spreadValues({}, props), props.title));
}
export {
  TagChakra
};
